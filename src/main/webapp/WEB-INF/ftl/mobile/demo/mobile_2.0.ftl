...
<head>
    ...
    <link rel="stylesheet" href="/layui_2.0/css/layui.mobile.css">
    <#--
    ...
    <#---->
    <link id="layuicss-skinlayim-mobilecss" rel="stylesheet" href="/layui_2.0/css/modules/layim/mobile/layim.css?v=2.0" media="all">
...
<script src="/layui_2.0/layui.js"></script>
